    ...
    <asp:Repeater ID="rptVideos" runat="server" OnItemCommand="rptVideos_ItemCommand">
        <ItemTemplate>
            <div class="video-card">
                ...
                <asp:Button ID="Button1" CssClass="remove-btn" runat="server" Text="Remove" CommandName="removeFromList" UseSubmitBehavior="False" OnClientClick="return confirm('Are you sure you want to remove this video?');"/>
            </div>
        </ItemTemplate>
    </asp:Repeater>
</asp:Content>
